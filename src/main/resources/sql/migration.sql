...
(4,'Are you a fan of 70s rock?','I am not really, but I was curious if this book would live up to the hype. Unfortunately, I dont think that it really did. As the third book I have read by TJR, it was good but left me wondering   what the whole point of the book was... It didnt feel like there is a true plot to this one. Its the  story of a band. There is history of course, but where is it leading? To the band breaking up? Just the course of the band?
  ...
  The content it good - I really felt like I was following the band, I am not sure why. Overall   enjoyable, but not something I would read again.','2022-03-21',3,15,10),
...
','2022-03-21',5,17,9),
(7,'Challenging read','This novel was not exactly an easy read, but it was challenging in a good way. The narrator, Marie Mitchell, is a character full of nuance and complications. She works for the FBI in the 1980s and finds herself pulled into an intelligence operation to bring down a West African leader. Marie has her own agenda, too, and she has an interest in learning more about the man behind this operation, who has a connection to her sisters death. All of this makes for a fascinating story and one that made me realize how little I knew about the Cold War in Africa.','2022-03-21',4,18,8),
(8,'No, just no!','I simply cannot fathom how this book got so many good reviews. I thought the plot line was ridiculous, and it was poorly written and filled with cardboard characters that I couldnt care less about. Virtually everyone in this book was either a psychopath who blithely committed murder or a cynic who moved through life with hardly any redeeming qualities. Horrible book!','2022-03-21',1,19,7),
...
(12,'A little repetitive','I found this a little long and maybe a little repetitive, but it is one of the better examples of the dying of cancer memoir genre thanks to its introspection and unflinching honesty.','2022-03-21',3,23,2),
(13,'Mostly meh','Retired film producer Marty and his grown (supposedly) daughters Janine and Amanda (who has twin daughters) and their dysfunctional relationships, including Marty`s with his first ex-wife Bunny. He reconnects with Bunny when they are both in rehab in Malibu. Marty has a history of bad relationships and is currently in one with Gail who seems to only want his money, never minding Marty is practically out of his. There is a wide range of personalities in the characters in the book. I liked Henry and Janine, for the most part, after she arrived in LA.','2022-03-21',3,24,4),
...
Definitely some sadness involved but not too overwhelming. This is an interesting concept to consider.','2022-03-21',4,25,5),
(15,'Terrific read!','Terrific book - a slow start but then you grow to love the characters….','2022-03-21',5,2,3),
(16,'A wonderful experience','Reading this was one of the most wonderful experiences in my life, like diving into another, euphoric world.','2022-03-21',5,26,2),
